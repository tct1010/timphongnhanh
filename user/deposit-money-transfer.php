                ...
                <table class="table table-bordered table-post-list" id = "">
                    ...
                    <tbody >
                        <tr>
                            ...
                            <td>
                                <div class="text-copy"> 
                                    <input type="text" name="" id="code-payVCB" value = "0861xxx92345" disabled>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-copy"> 
                                    <input type="text" name="" id="code-payMB" value = "19991xxxx99" disabled>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-copy"> 
                                    <input type="text" name="" id="code-payVTin" value = "1068xxxxx0982" disabled>
