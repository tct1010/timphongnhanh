<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $conn->prepare("INSERT INTO tbl_news(title,slug,image_logo,content,id_admin) VALUE(:title,:slug,:image_logo,:content,:id_admin)");
...
<body>
        ...
        <div id="main-right">
            ...
            <form action="" method="post" enctype="multipart/form-data" id = "frm-post">
                ...
                <div class="input-file form-validator block">
                    ...
                    <div id = "remove" style = "margin-left: 55px;"></div>
                </div>
                <div class="form-input form-validator">
                    <p class="item-name">Nội dung mô tả</p>
                    <textarea type="text" name="post_content" id="post_content" class="input-content form-focus boder-ra-5" rows="80" ></textarea>
                    <p class="form-message"></p>
                </div>
    ...
    <div class="noti">
        <div class="success-checkmark">
            ...
            <a href="./make-news.php" class="btn">OK</a>
        </div>
    </div>
    <?php }?>
    <!-- Thông báo thất bại -->
    ...
    <script>
        Validator({
            ...
            rules: [
                ...
                Validator.isRequired('#upload-img-news', 'Vui lòng tải lên 1 hình ảnh'), 
            ],
        });
    </script>
</body>
